import { calculate } from "./arabicConversion3";

describe('calculate arabicConversion3', () => {
    ...
    it('conversion the number 2999', () => {
        entredNumber = 2999;
        result = "twenty-nine hundred and ninety-nine";
        textNumber = calculate(entredNumber)
        expect(textNumber).toEqual(result);
    });
